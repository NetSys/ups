...
if __name__ == "__main__":
  ...
  for inp in xrange(0 , len(input_files)):
    ...
    count  = 0
    f1 = open("avgfcts/"+corename, 'w')
    f2 = open("avgfcts/bulk-"+corename, 'w')
    f3 = open("avgfcts/weighted-"+corename, 'w')
    f4 = open("avgfcts/bucket-"+corename, 'w')
    ...
    for bucketkey in bucket.keys():
      f[bucketkey] = open("avgfcts/" + bucketkey + "-" + corename, 'w')
